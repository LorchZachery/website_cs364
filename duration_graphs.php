...
$query = "SELECT workout.* FROM workout, user_work, user  WHERE workout.workout_count = user_work.workout_count AND user_work.user_id = user.user_id AND user.username=?;";
